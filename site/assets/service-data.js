  ...
  "insurance.html": {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Through our partner <strong class=\"text-brand-900\">InsurTech Hub</strong>, DHI offers <strong class=\"text-brand-900\">ITH SmartCare</strong> — group medical for small business, with as few as <strong class=\"text-brand-900\">5 employees</strong>, available in all <strong class=\"text-brand-900\">50 states</strong>. Four plans span <strong class=\"text-brand-900\">Cigna EPO</strong>, <strong class=\"text-brand-900\">PHCS PPO</strong>, and — on the Premier plan — a choice of <strong class=\"text-brand-900\">Cigna PPO National</strong> or <strong class=\"text-brand-900\">UnitedHealthcare Choice Plus</strong>, each paired with an <strong class=\"text-brand-900\">integrated gap benefit</strong> that lowers the member's net out-of-pocket. The debt-free <strong class=\"text-brand-900\">Premier</strong> plan reduces net out-of-pocket to <strong class=\"text-brand-900\">$0</strong> when care is coordinated through the plan. Rates from <strong class=\"text-brand-900\">$354.53 / employee / month</strong>.",
          "Group medical is quoted on a short consultation call. <a class=\"font-semibold text-cyan-700 hover:underline\" href=\"smartcare.html\">See the plans, benefits &amp; rates and request a group quote &rarr;</a>",
      ...
      },
      {
        ...
        items: [
          { title: "Debt-free Premier plan", desc: "The Premier plan brings the member's net out-of-pocket to $0 when care is coordinated through the plan." },
          { title: "Rates from $354.53 / employee / mo", desc: "Four plans and networks to fit budget; final pricing confirmed at underwriting." },
          { title: "Built for small business", desc: "Group coverage for as few as 5 employees, in all 50 states." },
          { title: "Cigna, UnitedHealthcare & PHCS", desc: "Cigna EPO, PHCS PPO, or a choice of Cigna PPO National / UnitedHealthcare Choice Plus (Premier)." },
          { title: "Integrated gap benefit", desc: "A TPA-administered gap benefit offsets covered deductible and coinsurance to lower net out-of-pocket." },
  ...
  "supplies.html": {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "DHI Supplies is your source for <b>lab consumables &amp; rapid-diagnostic-kit accessories</b> — transfer pipettes, rapid-test cassettes, blood-collection tubes, PCR &amp; cryo tubes, specimen containers, and histology cassettes — manufactured to ISO 13485 · CE · US-FDA standards for diagnostic manufacturers, hospitals &amp; labs. <a class=\"font-semibold text-cyan-700 hover:underline\" href=\"supplies-labware.html\">Browse the lab-consumables range &rarr;</a>",
        ],
      },
      {
        type: "prose",
