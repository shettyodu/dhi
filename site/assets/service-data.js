...
const SERVICE_CONTENT = {
  ...
  "automotive.html": {
    partner: "AutoCommand AI Marketplace",
    lead:
    ...
    sections: [
      ...
      },
      {
        ...
        intro: "Optional protection is embedded at the right step — with clear prices, limits, exclusions, and providers, never sold as confusing add-ons:",
        cols2: true,
        items: [
          "30 / 60 / 90-Day Confidence repair-support plans",
          "Wheel & tire protection",
          "Road-hazard protection",
          "Destination & transit protection",
